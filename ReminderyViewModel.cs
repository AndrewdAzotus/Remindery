...
using static Remindery.Remindery;

namespace Remindery
{
    class ReminderyViewModel : INotifyPropertyChanged
    {
        ...
        private string _Comment = "What Ever wi";
        ...
        public ICommand CmdExit
        {
            get
            {
                return _CmdExit ?? (_CmdExit = new CommandHandler(() => Exit(), _canExecCmdExit));
            }
        }
